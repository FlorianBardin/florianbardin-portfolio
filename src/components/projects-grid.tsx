...
const features = [
  {
    ...
    className: "md:col-span-2 lg:col-start-1 lg:col-end-1",
  },
  {
    Icon: Satellite,
    name: "APOD Viewer",
    ...
    className: "md:col-span-2 lg:col-start-2 lg:col-end-2",
  },
  {
    Icon: SquareKanban,
    name: "Task Flow",
    ...
    className: "md:col-span-1 lg:col-start-3 lg:col-end-3",
  },
  {
    Icon: Gamepad2,
    ...
    className: "md:col-span-1 lg:col-start-4 lg:col-end-4",
  },
];
